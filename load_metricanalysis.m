...
% implementation on sliding window 
...
% here we want to apply the cleaning process on a sliding window - call
% irf_accel_ecg on a section by section basis and compile back together

% dont run fft_analysis -> generate new code to call the different metrics
% we want to use (probably wont require fft directly and we dont want to
% generate all the figures anymore 
